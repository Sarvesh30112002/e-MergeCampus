      ...
      <div className="row p-5 home_about_container">
        <div className="col-lg-6">
          ...
          <p className="home_about_description_main">
            ...
            members of Team <strong> eMergeCampus</strong>. We all have tried our
        ...
        <div className="col-lg-6 d-flex align-items-center justify-content-center">
          <div className="logo">
            ...
            />
            <img
              src="https://see.fontimg.com/api/renderfont4/6RYYq/eyJyIjoiZnMiLCJoIjo4MSwidyI6MTI1MCwiZnMiOjY1LCJmZ2MiOiIjMDAwMDAwIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/ZU1lcmdlQ2FtcHVz/constantly-challenged-demo-italic.png"
              alt="Hindi fonts"
              width="280"
              height="100"
              className="align-top"
