...
const ipfs = new IPFS({
  host: "127.0.0.1", // Your local IPFS node's host
  port: 5001, // Your local IPFS node's port
  protocol: "http", // The protocol used to communicate with your local IPFS node
});
